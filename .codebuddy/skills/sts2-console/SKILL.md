...
# 获取 Mod 卡牌
card PERSONALMOD_CARD_MY_CARD hand
```
...
# 获得 Mod 遗物
relic PERSONALMOD_RELIC_MY_RELIC

# 移除遗物
relic remove PERSONALMOD_RELIC_MY_RELIC

# 获得药水
potion PERSONALMOD_POTION_TEST_POTION

# 给自己施加 5 层力量
power PERSONALMOD_POWER_STRENGTH_POWER 5 0

# 给第一个敌人施加 2 层易伤
power PERSONALMOD_POWER_VULNERABLE_POWER 2 1
...
ancient PERSONALMOD_ANCIENT_TEST_ANCIENT Akabeko

# 触发指定怪物遭遇
fight PERSONALMOD_ENCOUNTER_TEST_ENCOUNTER
...
| 类型 | 格式 | 示例 |
|------|------|------|
| 卡牌 | `<MODID>_CARD_<TYPENAME>` | `PERSONALMOD_CARD_STRIKE` |
| 遗物 | `<MODID>_RELIC_<TYPENAME>` | `PERSONALMOD_RELIC_TEST_RELIC` |
| 能力 | `<MODID>_POWER_<TYPENAME>` | `PERSONALMOD_POWER_TEST_POWER` |
| 药水 | `<MODID>_POTION_<TYPENAME>` | `PERSONALMOD_POTION_TEST_POTION` |
| 怪物 | `<MODID>_MONSTER_<TYPENAME>` | `PERSONALMOD_MONSTER_TEST_MONSTER` |
| 事件 | `<MODID>_EVENT_<TYPENAME>` | `PERSONALMOD_EVENT_TEST_EVENT` |
| Ancient | `<MODID>_ANCIENT_<TYPENAME>` | `PERSONALMOD_ANCIENT_TEST_ANCIENT` |
| 附魔 | `<MODID>_ENCHANTMENT_<TYPENAME>` | `PERSONALMOD_ENCHANTMENT_ADROIT` |
| 遭遇 | `<MODID>_ENCOUNTER_<TYPENAME>` | `PERSONALMOD_ENCOUNTER_TEST` |
| 充能球 | `<MODID>_ORB_<TYPENAME>` | `PERSONALMOD_ORB_TEST_ORB` |
